              ...
              <div>
                ...
                <div class="grid gap-5 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium mb-1"
                        for="mandatory"
                        >Mandatory <span class="text-rose-500">*</span></label
                      >
                      <input
                        id="mandatory"
                        class="form-input w-full"
                  ...
                  <div>
                    <!-- Start -->
                    <div>
                      <label class="block text-sm font-medium mb-1" for="prefix"
                        >W/ Prefix</label
                      >
                      <div class="relative">
                        <input
                        ...
                        >
                          <span class="text-sm text-slate-400 font-medium px-3"
                            >USD</span
                          >
                        </div>
                      </div>
                  ...
                  <div>
                    <!-- Start -->
                    <div>
                      <label class="block text-sm font-medium mb-1" for="suffix"
                        >W/ Suffix</label
                      >
                      <div class="relative">
                        <input
                  ...
                  <div>
                    <!-- Start -->
                    <form>
                      <label class="block text-sm font-medium mb-1" for="icon"
                        >W/ Icon</label
                      >
                      <div class="relative">
                        <input
                        ...
                        >
                          <svg
                            class="w-4 h-4 fill-current text-slate-400 shrink-0 ml-3 mr-2"
                            viewBox="0 0 16 16"
                          >
                            <path
              ...
              <div>
                ...
                <div class="grid gap-5 md:grid-cols-3">
                  ...
                  <div>
                    <!-- Start -->
                    <div>
                      <label class="block text-sm font-medium mb-1" for="normal"
                        >Default</label
                      >
                      <input
                        id="normal"
                    ...
                    <div>
                      <div>
                        <label
                          class="block text-sm font-medium mb-1"
                          for="error"
                          >Error <span class="text-rose-500">*</span></label
                        >
                        <input
                          id="error"
                          class="form-input w-full border-rose-300"
                          type="text"
                        />
                      </div>
                    ...
                    <div>
                      <div>
                        <label
                          class="block text-sm font-medium mb-1"
                          for="success"
                          >Success <span class="text-rose-500">*</span></label
                        >
                        <input
                          id="success"
                          class="form-input w-full border-primary-300"
                          type="text"
                        />
                      </div>
                      <div class="text-xs mt-1 text-primary-500">
                        Sounds good!
                      </div>
                    </div>
                    <!-- End -->
                ...
                <div class="flex flex-wrap items-center -m-3">
                  ...
                  <div class="m-3">
                    ...
                    <label class="flex items-center">
                      <input
                        type="checkbox"
                        class="form-checkbox disabled:bg-slate-50"
                        disabled
                      />
                  ...
                  <div class="m-3">
                    ...
                    <label class="flex items-center">
                      <input
                        type="radio"
                        name="radio-buttons"
                        class="form-radio disabled:bg-slate-50"
                        disabled
                      />
                      <span class="text-sm ml-2">Disabled</span>
                    </label>
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        <input
                          ...
                          disabled
                        />
                        <label class="bg-slate-400" for="toggle3">
                          <span
                            class="bg-white shadow-sm"
                            aria-hidden="true"
                          ></span>
