                ...
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    <button
                      ...
                      @click.stop="scrollbarModalOpen = true"
                    >
                      Modal w/ Scroll Bar
                    </button>
                    <ModalBasic
                      ...
                      @close-modal="scrollbarModalOpen = false"
                    ...
                    >
                        ...
                        <div class="text-sm">
                          ...
                          <div class="space-y-2">
                            ...
                            <p>
                              ...
                              interdum varius sit. Nec sagittis aliquam
                              malesuada bibendum arcu vitae elementum curabitur
                              vitae. Mattis enim ut tellus elementum el
                              fringilla est ullamcorper eget nulla. Enim eu
                              turpis egestas pretium aenean pharetra magna.
                              Aliquam id diam maecenas ultricies mi eget us
                              mauris vitae ultricies leo integer t malesuada
                              fames ac turpis egestas maecenas pharetra volutpat
                              lacus laoreet non.
                            </p>
                            <p>
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                      ...
                      <!-- Modal footer -->
                      <div
                        class="sticky bottom-0 px-5 py-4 bg-white border-t border-slate-200"
                      >
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button
                            class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                            @click.stop="scrollbarModalOpen = false"
                          >
                            Close
                          </button>
                          <button
                  ...
                  <div class="m-1.5">
                    ...
                    <button
                      ...
                      @click.stop="cookiesModalOpen = true"
                    >
                      Cookies
                    </button>
                    <ModalCookies
                      ...
                      @close-modal="cookiesModalOpen = false"
                    ...
                    >
                      ...
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button
                          class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                          @click.stop="cookiesModalOpen = false"
                        >
                          Decline
                        </button>
                        <button
                ...
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    <button
                      ...
                      @click.stop="successModalOpen = true"
                    >
                      Success Modal
                    </button>
                    <ModalBlank
                ...
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    >
                      ...
                      <div class="mb-2 text-center">
                        ...
                        <div class="mb-3">
                          <svg
                            class="inline-flex w-12 h-12 rounded-full shrink-0 fill-current"
                            viewBox="0 0 48 48"
                          >
                            <rect
                      ...
                      <div class="text-center">
                        ...
                        <form class="flex max-w-sm m-auto">
                          <div class="grow mr-2">
                            <label for="subscribe-form" class="sr-only"
                              >Leave your Email</label
                            >
                            <input
                              id="subscribe-form"
                              class="form-input w-full px-2 py-1"
                          ...
                          <button
                            type="submit"
                            class="btn-sm bg-primary-500 hover:bg-primary-600 text-white whitespace-nowrap"
                          >
                            Subscribe
                          </button>
                        </form>
                  ...
                  <div class="m-1.5">
                    ...
                    <button
                      ...
                      @click.stop="announcementModalOpen = true"
                    >
                      Announcement
                    </button>
                    <ModalAction
                      ...
                      @close-modal="announcementModalOpen = false"
                    >
                      <!-- Modal header -->
                      <div class="mb-2 text-center">
                        <!-- Icon -->
                      ...
                      <div class="text-center">
                        ...
                        <div class="space-y-3">
                          ...
                          <div>
                            <a
                              class="font-medium text-sm text-primary-500 hover:text-primary-600"
                              href="#0"
                              @click.prevent="announcementModalOpen = false"
                              >Not Now!</a
                            >
                          </div>
                        </div>
                  ...
                  <div class="m-1.5">
                    ...
                    <button
                      ...
                      @click.stop="integrationModalOpen = true"
                    >
                      Integration
                    </button>
                    <ModalAction
                      ...
                      @close-modal="integrationModalOpen = false"
                    >
                      <!-- Modal header -->
                      <div class="mb-5 text-center">
                        <!-- Icons -->
                        <div
                          class="inline-flex items-center justify-center space-x-3 mb-4"
                        >
                          <!-- Mosaic logo -->
                      ...
                      <div class="text-sm mb-5">
                        ...
                        <ul class="space-y-2 mb-5">
                          <li class="flex items-center">
                            <svg
                              class="w-3 h-3 shrink-0 fill-current text-primary-500 mr-2"
                              viewBox="0 0 12 12"
                            >
                              <path
                      ...
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button
                          class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                          @click.stop="integrationModalOpen = false"
                        >
                          Cancel
                        </button>
                        <button
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBlank
                      ...
                      @close-modal="newsModalOpen = false"
                    >
                      <div class="relative">
                        <img
                          class="w-full"
                        ...
                        <button
                          ...
                          @click.stop="newsModalOpen = false"
                        >
                      ...
                      <div class="p-5">
                        ...
                        <div class="mb-2">
                          <div class="mb-3">
                            <div
                              class="text-xs inline-flex font-medium bg-primary-100 text-primary-600 rounded-full text-center px-2.5 py-1"
                            >
                              New on Mosaic
                            </div>
                          </div>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic
                      ...
                      @close-modal="planModalOpen = false"
                    ...
                    >
                      ...
                      <div class="px-5 pt-4 pb-1">
                        <div class="text-sm">
                          ...
                          <ul class="space-y-2 mb-4">
                            <li>
                              <button
                                class="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-primary-400 shadow-sm duration-150 ease-in-out"
                              >
                                <div class="flex items-center">
                                  <div
                                    class="w-4 h-4 border-4 border-primary-500 rounded-full mr-3"
                                  ></div>
                                  <div class="grow">
                                    <div
                            ...
                            <li>
                              ...
                              >
                                <div class="flex items-center">
                                  <div
                                    class="w-4 h-4 border-2 border-slate-300 rounded-full mr-3"
                                  ></div>
                                  <div class="grow">
                                    <div
                                      class="flex flex-wrap items-center justify-between mb-0.5"
                                    >
                                      <span class="font-semibold text-slate-800"
                                        >Mosaic Basic
                                        <span
                                          class="text-xs italic text-primary-500 align-top"
                                          >Best Value </span
                                        ></span
                                      >
                                      <span
                              ...
                              >
                                <div class="flex items-center">
                                  ...
                                  <div class="grow">
                                    ...
                                    <div class="text-sm">
                                      10 MB · 5 members · Unlimited block limits
                                    </div>
                                  </div>
                                </div>
                              </button>
                      ...
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button
                            class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                            @click.stop="planModalOpen = false"
                          >
                            Cancel
                          </button>
                          <button
