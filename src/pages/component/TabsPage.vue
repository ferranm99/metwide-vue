        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="border-t border-slate-200">
            ...
            <div class="space-y-8 mt-8">
              <!-- Simple -->
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">Simple</h2>
                <!-- Start -->
                <div class="mb-8 border-b border-slate-200">
                  ...
                  >
                    ...
                    >
                      <a class="text-primary-500 whitespace-nowrap" href="#0"
                        >Account</a
                      >
                    </li>
                    <li
              ...
              <div>
                ...
                <div class="relative mb-8">
                  ...
                  >
                    ...
                    >
                      <a
                        class="block pb-3 text-primary-500 whitespace-nowrap border-b-2 border-primary-500"
                        href="#0"
                        >Account</a
                      >
                    </li>
              ...
              <div>
                ...
                <div class="mb-8 border-b border-slate-200">
                  ...
                  >
                    ...
                    >
                      <a
                        class="text-primary-500 whitespace-nowrap flex items-center"
                        href="#0"
                      >
                        <svg
                    ...
                    >
                      <a
                        class="text-slate-500 hover:text-slate-600 whitespace-nowrap flex items-center"
                        href="#0"
                      >
                        <svg
                          class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2"
                          viewBox=" 0 0 16 16"
                        >
                          <path
              ...
              <div>
                ...
                <ul class="flex flex-wrap -m-1">
                  <li class="m-1">
                    <button
                      class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-primary-500 text-white duration-150 ease-in-out"
                    >
                      Account
                    </button>
                  </li>
