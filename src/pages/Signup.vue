  ...
  <main class="bg-white">
    <div class="relative flex">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label class="block text-sm font-medium mb-1" for="role"
                    >Your Role <span class="text-rose-500">*</span></label
                  >
                ...
                <div class="mr-1">
                  <label class="flex items-center">
                    ...
                    <span class="text-sm ml-2"
                      >Email me about product news.</span
                    >
                  </label>
                </div>
                <router-link
                  class="btn bg-primary-500 hover:bg-primary-600 text-white ml-3 whitespace-nowrap"
                  to="/"
                  >Sign Up</router-link
                >
              </div>
      ...
      >
        ...
        />
        <img
          class="absolute top-1/4 left-0 transform -translate-x-1/2 ml-8 hidden lg:block"
