<template>
  <div v-show="open">
    <div
      class="inline-flex min-w-80 px-4 py-2 rounded-sm text-sm bg-white shadow-lg border border-slate-200 text-slate-600"
    >
      <div class="flex w-full justify-between items-start">
        <div class="flex">
          ...
          <svg
            ...
            class="w-4 h-4 shrink-0 fill-current text-rose-500 mt-[3px] mr-3"
            viewBox="0 0 16 16"
          >
            <path
          ...
          <svg
            ...
            class="w-4 h-4 shrink-0 fill-current text-primary-500 mt-[3px] mr-3"
            viewBox="0 0 16 16"
          >
            <path
