<template>
  <div v-show="open">
    <div
      class="inline-flex min-w-80 px-4 py-2 rounded-sm text-sm border"
  ...
  setup() {
    const typeColor = (type) => {
      switch (type) {
        ...
        case "success":
          return "bg-primary-100 border-primary-200 text-primary-600";
        default:
          return "bg-primary-100 border-primary-200 text-primary-500";
      }
    };
