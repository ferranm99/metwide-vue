<template>
  <div class="relative inline-flex">
    ...
    >
      <div
        v-show="dropdownOpen"
        class="origin-top-right z-10 absolute top-full min-w-56 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
      ...
      >
        ...
        >
          <li>
            ...
            >
              <svg
                class="w-3 h-3 fill-current text-primary-300 shrink-0 mr-2"
                viewBox="0 0 12 12"
              >
          ...
          <li>
            <a
              class="font-medium text-sm text-primary-500 hover:text-primary-600 flex items-center py-1 px-3"
              target="_blank"
              href="https://metwide.screenconnect.com/"
              @click="dropdownOpen = false"
            >
              <svg
                class="w-3 h-3 fill-current text-primary-300 shrink-0 mr-2"
              ...
              <span>Online Remote Support</span>
            </a>
          </li>
          <li>
            <a
              class="font-medium text-sm text-primary-500 hover:text-primary-600 flex items-center py-1 px-3"
              href="https://www.metwide.com.au/contact-us"
              target="_blank"
              @click="dropdownOpen = false"
            >
              <svg
