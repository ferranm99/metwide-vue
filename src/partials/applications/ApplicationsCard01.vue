      ...
      <div class="grow flex flex-col p-5">
        ...
        <div class="grow">
          ...
          <div class="flex items-center space-x-2 mb-4">
            ...
            <!-- Rate -->
            <div
              class="inline-flex text-sm font-medium bg-amber-100 text-amber-600 rounded-full text-center px-2.5 py-0.5"
            >
              {{ item.rating }}
            </div>
          </div>
          ...
          <ul class="text-sm space-y-2 mb-5">
            <li v-if="item.feat01" class="flex items-center">
              <svg
                class="w-4 h-4 fill-current text-slate-400 shrink-0 mr-3"
                viewBox="0 0 16 16"
              >
                <path
            ...
            <li v-if="item.feat02" class="flex items-center">
              <svg
                class="w-4 h-4 fill-current text-slate-400 shrink-0 mr-3"
                viewBox="0 0 16 16"
              >
            ...
            <li v-if="item.feat03" class="flex items-center">
              <svg
                class="w-4 h-4 fill-current text-slate-400 shrink-0 mr-3"
                viewBox="0 0 16 16"
              >
            ...
            <li v-if="item.feat04" class="flex items-center">
              <svg
                class="w-4 h-4 fill-current text-slate-400 shrink-0 mr-3"
                viewBox="0 0 16 16"
              >
