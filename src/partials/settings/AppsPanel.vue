    ...
    <div class="p-6">
      ...
      <div class="mb-6">
        ...
        <div class="mb-4 border-b border-slate-200">
          ...
          >
            ...
            >
              <a class="text-primary-500 whitespace-nowrap" href="#0">View All</a>
            </li>
            <li
              class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8"
            >
      ...
      <section class="pb-6 border-b border-slate-200">
        <div class="grid grid-cols-12 gap-6">
          <!-- Card 1 -->
          <div
            class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-slate-200"
          >
            <!-- Card content -->
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div
                    class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-primary-500 to-primary-300 mr-3"
                  >
                    <svg
                ...
                <div class="flex flex-wrap justify-between items-center">
                  ...
                  <div class="flex space-x-3">
                    <div class="flex items-center text-slate-400">
                      <svg
                        class="w-4 h-4 shrink-0 fill-current mr-1.5"
                        viewBox="0 0 16 16"
                      >
                        <path
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div
                    class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-sky-500 to-sky-300 mr-3"
                  >
                    <svg
                      class="w-10 h-10 fill-current text-white"
                      viewBox="0 0 40 40"
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div
                    class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-rose-500 to-rose-300 mr-3"
                  >
                    <svg
                      class="w-10 h-10 fill-current text-white"
                      viewBox="0 0 40 40"
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div
                    class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-amber-500 to-amber-300 mr-3"
                  >
                    <svg
                      class="w-10 h-10 fill-current text-white"
                      viewBox="0 0 40 40"
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div
                    class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-slate-500 to-slate-300 mr-3"
                  >
                    <svg
                      class="w-10 h-10 fill-current text-white"
                      viewBox="0 0 40 40"
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              ...
              <footer class="mt-2">
                <div class="flex flex-wrap justify-between items-center">
                  <!-- Left side -->
                  <div class="text-sm text-slate-500 italic">400+ Apps</div>
                  <!-- Right side -->
                  <a
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              ...
              <footer class="mt-2">
                <div class="flex flex-wrap justify-between items-center">
                  <!-- Left side -->
                  <div class="text-sm text-slate-500 italic">320+ Apps</div>
                  <!-- Right side -->
                  <a
                    class="text-sm font-medium text-primary-500 hover:text-primary-600"
                    href="#0"
          ...
          >
            ...
            <div class="flex flex-col h-full p-5">
              ...
              <footer class="mt-2">
                <div class="flex flex-wrap justify-between items-center">
                  <!-- Left side -->
                  <div class="text-sm text-slate-500 italic">270+ Apps</div>
                  <!-- Right side -->
                  <a
                    class="text-sm font-medium text-primary-500 hover:text-primary-600"
                    href="#0"
