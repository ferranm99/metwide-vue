          ...
          <div class="px-8 py-8">
            <div class="md:grid grid-cols-12 gap-4">
              ...
              <div class="col-span-6">
                ...
                >
                <input
                  v-model="userFields.mobileNumber"
                  id="mobileNumber"
                  class="form-input w-full px-2 py-1"
                  type="number"
                />
          ...
          <div class="px-5 py-4">
            <div class="flex flex-wrap justify-end space-x-2">
              <button
                ...
                @click.stop="addUserModalOpen = false"
              >
                Cancel
              </button>
              <button
...
export default {
  ...
  setup(context) {
    ...
    const addAccountUser = async () => {
      ...
      try {
        await api.get("sanctum/csrf-cookie");
        const res = await api.post("user/add-account-user", userFields.value);
        if (res.data === "Exists") {
