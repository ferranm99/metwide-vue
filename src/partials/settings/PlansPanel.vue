<template>
  <div class="grow">
    ...
    <div class="p-6 space-y-6">
        ...
        <div>
          ...
          <div class="flex items-center space-x-3 mb-6">
            ...
            <div class="text-sm text-slate-500 font-medium">
              Annually <span class="text-primary-500">(-20%)</span>
            </div>
          </div>
          <!-- Pricing tabs -->
          <div class="grid grid-cols-12 gap-6">
            <!-- Tab 1 -->
            <div
              class="relative col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-slate-200"
            >
              <div
              ...
              <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                <header class="flex items-center mb-2">
                  <div
                    class="w-6 h-6 rounded-full shrink-0 bg-gradient-to-tr from-primary-500 to-primary-300 mr-3"
                  >
                    <svg
                ...
                <div class="text-slate-800 font-bold mb-4">
                  ...
                  ><span class="text-3xl">{{ annual ? "14" : "19" }}</span
                  ><span class="text-slate-500 font-medium text-sm">/mo</span>
                </div>
                <!-- CTA -->
                <button
                  class="btn border-slate-200 hover:border-slate-300 text-slate-600 w-full"
                >
                  Downgrade
                </button>
              </div>
            ...
            >
              ...
              <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                ...
                <div class="text-slate-800 font-bold mb-4">
                  <span class="text-2xl">$</span
                  ><span class="text-3xl">{{ annual ? "34" : "39" }}</span
                  ><span class="text-slate-500 font-medium text-sm">/mo</span>
                </div>
                <!-- CTA -->
                <button
                  class="btn border-slate-200 bg-slate-100 text-slate-400 w-full cursor-not-allowed flex items-center"
                  disabled
                >
                  <svg
                    class="w-3 h-3 shrink-0 fill-current mr-2"
                    viewBox="0 0 12 12"
                  >
                    <path
                      d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z"
            ...
            >
              ...
              <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                ...
                <div class="text-slate-800 font-bold mb-4">
                  <span class="text-2xl">$</span
                  ><span class="text-3xl">{{ annual ? "74" : "79" }}</span
                  ><span class="text-slate-500 font-medium text-sm">/mo</span>
                </div>
                <!-- CTA -->
                <button
                  class="btn bg-primary-500 hover:bg-primary-600 text-white w-full"
                >
                  Upgrade
                </button>
              </div>
      ...
      <section>
        <div
          class="px-5 py-3 bg-primary-50 border border-primary-100 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center"
        >
