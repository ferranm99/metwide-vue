<template>
  <div class="grow">
    ...
    <div class="p-6 space-y-6">
      <div>
        <h2 class="text-2xl text-slate-800 font-bold mb-4">Give Feedback</h2>
        <div class="text-sm">
        ...
        <div class="w-full max-w-xl">
          <div class="relative">
            ...
            <ul class="relative flex justify-between w-full">
              <li class="flex">
                <button
                  class="w-3 h-3 rounded-full bg-white border-2 border-slate-400"
                >
              ...
              <li class="flex">
                <button
                  class="w-3 h-3 rounded-full bg-primary-500 border-2 border-primary-500"
                >
          ...
          <div
            class="w-full flex justify-between text-sm text-slate-500 italic mt-3"
          >
            <div>Not at all</div>
